...
export const startEntries: GettingStartedStartEntryContent = [
	{
		id: 'topLevelSolanaAnchorProject',
		title: localize('gettingStarted.solana.newProject.title', "New Solana Anchor Project..."),
		description: localize('gettingStarted.solana.newProject.description', "Scaffold a new Solana program and app workspace"),
		icon: Codicon.symbolClass,
		when: '!isWeb',
		content: {
			type: 'startEntry',
			command: 'command:solana.anchor.newProject',
		}
	},
	{
...
export const walkthroughs: GettingStartedWalkthroughContent = [
	{
		id: 'Setup',
		title: localize('gettingStarted.setup.title', "Get started with Solana IDE"),
		description: localize('gettingStarted.setup.description', "Set up your Solana toolchain, wallet, and first Anchor workflow"),
		isFeatured: true,
		icon: setupIcon,
		when: '!isWeb',
		walkthroughPageTitle: localize('gettingStarted.setup.walkthroughPageTitle', 'Setup Solana IDE'),
		next: 'Beginner',
		content: {
			type: 'steps',
			steps: [
				{
					id: 'solanaAnchorScaffold',
					title: localize('gettingStarted.solana.anchorScaffold.title', "Create your first Anchor project"),
					description: localize('gettingStarted.solana.anchorScaffold.description', "Use the guided scaffold to generate a Solana program and client workspace.\n{0}", Button(localize('gettingStarted.solana.anchorScaffold.button', "Create Anchor Project"), 'command:solana.anchor.newProject')),
					when: '!isWeb',
					media: { type: 'svg', altText: 'Open folder and scaffold project', path: 'openFolder.svg' }
				},
				{
					id: 'solanaWalletSetup',
					title: localize('gettingStarted.solana.walletSetup.title', "Configure your development wallet"),
					description: localize('gettingStarted.solana.walletSetup.description', "Generate or import a keypair, then verify your active wallet before deploys.\n{0}", Button(localize('gettingStarted.solana.walletSetup.button', "Open Wallet Panel"), 'command:solana.wallet.focus')),
					when: '!isWeb',
					media: { type: 'svg', altText: 'Settings panel for wallet setup', path: 'settings.svg' }
				},
				{
					id: 'solanaNetworkSetup',
					title: localize('gettingStarted.solana.networkSetup.title', "Select localnet or devnet"),
					description: localize('gettingStarted.solana.networkSetup.description', "Switch networks, start a local validator, and verify RPC connectivity.\n{0}", Button(localize('gettingStarted.solana.networkSetup.button', "Open Network Selector"), 'command:solana.anchor.selectNetwork')),
					when: '!isWeb',
					media: { type: 'svg', altText: 'Terminal for validator and RPC commands', path: 'terminal.svg' }
				},
				{
					id: 'solanaBuildDeploy',
					title: localize('gettingStarted.solana.buildDeploy.title', "Build, test, and deploy"),
					description: localize('gettingStarted.solana.buildDeploy.description', "Run Anchor build and test tasks, then deploy your program from the IDE.\n{0}", Button(localize('gettingStarted.solana.buildDeploy.button', "Run Anchor Build"), 'command:solana.anchor.build')),
					when: '!isWeb',
